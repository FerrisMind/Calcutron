...
pub fn create_history_display(history: String) -> Element<'static, (), Theme> {
    ...
    .style(|_theme: &Theme| container::Style {
        background: Some(iced::Background::Color(iced::Color::from_rgba8(
            26, 34, 39, 0.9,
        ))), // #1a2227 with 10% transparency (90% opacity)
...
pub fn create_display_container(
    history_display: Element<'static, (), Theme>,
    main_display: Element<'static, (), Theme>,
) -> Element<'static, (), Theme> {
    column![history_display, main_display]
