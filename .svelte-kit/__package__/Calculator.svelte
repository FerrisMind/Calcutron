	...
	{#if showSettings}
		<div class="settings-panel">
			<div class="settings-header">
				<h3>Настройки</h3>
				<button class="close-btn" onclick={() => showSettings = false} aria-label="Закрыть настройки"><i class="ph ph-x"></i></button>
			</div>
				...
				{#if !isSystemTheme}
					<div class="setting-item">
						<button class="theme-toggle-btn" onclick={toggleTheme}>
							<i class="ph {isDarkMode ? 'ph-moon' : 'ph-sun'}"></i> {isDarkMode ? 'Темная тема' : 'Светлая тема'}
						</button>
					</div>
				{/if}
				<div class="setting-item">
	...
	<div class="calculator">
		...
		<div class="calculator-header">
			...
			<div class="header-controls">
				<button class="control-btn" onclick={() => showSettings = !showSettings} title="Настройки (Ctrl+S)" aria-label="Открыть настройки">
					<i class="ph ph-gear"></i>
				</button>
				<button class="control-btn" onclick={toggleTheme} title="Переключить тему (Ctrl+T)" aria-label="Переключить тему">
		...
		{#if historyDisplay.length > 0}
			<div class="history">
				<div class="history-header">
					<span>История</span>
					<button class="clear-history-mini" onclick={() => history = []} title="Очистить историю (Ctrl+H)" aria-label="Очистить историю"><i class="ph ph-eraser"></i></button>
				</div>
		...
		<div class="buttons">
			...
			<div class="button-row">
				<button 
					...
					onclick={() => { animateButton('percentage'); percentage(); }}
					title="Процент (%)"
					aria-label="Процент"
				>
				...
				<button 
					...
					onclick={() => { animateButton('clear-entry'); clearEntry(); }}
				...
				<button 
					...
					onclick={() => { animateButton('clear'); clear(); }}
				...
				<button 
					...
					onclick={() => { animateButton('backspace'); backspace(); }}
			...
			<div class="button-row">
				<button 
					...
					onclick={() => { animateButton('sqrt'); squareRoot(); }}
				...
				<button 
					...
					onclick={() => { animateButton('power'); power(); }}
				...
				<button 
					...
					onclick={() => { animateButton('toggleSign'); toggleSign(); }}
					title="Изменить знак (±)"
				...
				<button 
					...
					onclick={() => { animateButton('/'); performOperation('/'); }}
					title="Деление (/)"
					aria-label="Деление"
				>
			...
			<div class="button-row">
				<button 
					...
					onclick={() => { animateButton('7'); inputDigit('7'); }}
				>
					7
				</button>
				<button 
					class="btn number-btn {lastPressedButton === '8' ? 'pressed' : ''}" 
					onclick={() => { animateButton('8'); inputDigit('8'); }}
				>
					8
				</button>
				<button 
					class="btn number-btn {lastPressedButton === '9' ? 'pressed' : ''}" 
					onclick={() => { animateButton('9'); inputDigit('9'); }}
				>
					9
				</button>
				<button 
			...
			<div class="button-row">
				<button 
					...
					onclick={() => { animateButton('4'); inputDigit('4'); }}
				>
					4
				</button>
				<button 
					class="btn number-btn {lastPressedButton === '5' ? 'pressed' : ''}" 
					onclick={() => { animateButton('5'); inputDigit('5'); }}
				>
					5
				</button>
				<button 
					class="btn number-btn {lastPressedButton === '6' ? 'pressed' : ''}" 
					onclick={() => { animateButton('6'); inputDigit('6'); }}
				>
					6
				</button>
				<button 
			...
			<div class="button-row">
				<button 
					...
					onclick={() => { animateButton('1'); inputDigit('1'); }}
				>
					1
				</button>
				<button 
					class="btn number-btn {lastPressedButton === '2' ? 'pressed' : ''}" 
					onclick={() => { animateButton('2'); inputDigit('2'); }}
				>
					2
				</button>
				<button 
					class="btn number-btn {lastPressedButton === '3' ? 'pressed' : ''}" 
					onclick={() => { animateButton('3'); inputDigit('3'); }}
				>
					3
				</button>
				<button 
			...
			<div class="button-row">
				<button 
					...
					onclick={() => { animateButton('0'); inputDigit('0'); }}
				>
					0
				</button>
				<button 
					class="btn number-btn {lastPressedButton === 'decimal' ? 'pressed' : ''}" 
					onclick={() => { animateButton('decimal'); inputDecimal(); }}
				...
				<button 
					...
					onclick={() => { animateButton('equals'); calculate(); }}
					title="Равно (Enter/=)"
					aria-label="Равно"
				>
